...
instance Print Geq where
  prt _ (Geq (_,i)) = doc (showString ( i))


instance Print Leq where
  prt _ (Leq (_,i)) = doc (showString ( i))


instance Print CEQ where
  prt _ (CEQ (_,i)) = doc (showString ( i))


instance Print Neq where
  prt _ (Neq (_,i)) = doc (showString ( i))


instance Print Gt where
  prt _ (Gt (_,i)) = doc (showString ( i))


instance Print Lt where
  prt _ (Lt (_,i)) = doc (showString ( i))
...
instance Print COM where
  prt i e = case e of
    ...
    AC_GEQ geq -> prPrec i 0 (concatD [prt 0 geq])
    AC_EQ ceq -> prPrec i 0 (concatD [prt 0 ceq])
    AC_NEQ neq -> prPrec i 0 (concatD [prt 0 neq])
    AC_LT lt -> prPrec i 0 (concatD [prt 0 lt])
    AC_GT gt -> prPrec i 0 (concatD [prt 0 gt])
